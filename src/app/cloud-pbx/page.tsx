...
export const metadata: Metadata = {
  ...
  description:
    "מרכזיה בענן מתקדמת לעסק: שלוחות, תורים, הקלטות, IVR חכם ושלוחות AI — בלי חומרה ובלי טכנאים. מרכזייה וירטואלית שעולה לאוויר תוך ימים.",
...
const features = [
  ...
  },
  {
    ...
    title: "ניהול מוקד ונציגים",
    description:
      "תורי המתנה חכמים, ניהול נציגים מתקדם, מוזיקת המתנה והודעות מותאמות — כל מה שמוקד מקצועי צריך.",
  },
  {
    icon: <Mic className="w-7 h-7 text-brand-accent" />,
    title: "הקלטות, תמלול וסיכום למייל",
    description:
      "כל שיחה מוקלטת ומתומללת אוטומטית. בסוף השיחה נשלח סיכום ברור למייל — עם חיפוש בטקסט והאזנה מהדפדפן.",
  },
  {
    icon: <BarChart3 className="w-7 h-7 text-pink-500" />,
    title: "דוחות וניתוח AI",
    description:
      "דשבורד חי לביצועי נציגים — ו-AI שמנתח כל שיחה עם ההקשר מהשיחות הקודמות של אותו לקוח.",
  },
  {
...
const faq = [
  ...
  },
  {
    ...
    answer:
      "מעבר ליכולות המרכזייה הסטנדרטיות, BotiPhone משלבת ניהול נציגים מתקדם, סיכום שיחה אוטומטי למייל ו-AI שמנתח כל שיחה עם ההקשר מהשיחות הקודמות — לצד סוכני AI שעונים בדיבור חופשי וקמפיינים יוצאים. הכל במערכת אחת.",
  },
  {
  ...
  return (
    <>
      ...
      <ServiceHero
        ...
        description="מרכזייה וירטואלית מתקדמת: שלוחות ותורים, ניהול נציגים, הקלטות, סיכום שיחה למייל ו-AI שמנתח שיחות עם ההקשר מהעבר — יחד עם API פתוח ושכבת סוכני AI מובנית."
        visual={<PbxVisual />}
      />
