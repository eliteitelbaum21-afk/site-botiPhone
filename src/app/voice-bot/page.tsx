...
export const metadata: Metadata = {
  ...
  description:
    "בוט טלפוני מבוסס בינה מלאכותית שעונה לכל שיחה נכנסת, מבין דיבור חופשי בעברית, קובע פגישות ומנתב שיחות. הסוף לתפריטי הקש 1. קבלו הדגמה חינם.",
...
export default function VoiceBotPage() {
  return (
    <>
      ...
      <CtaSection
        title="רוצים לשמוע את הבוט בפעולה?"
        subtitle="השאירו פרטים ונתקשר אליכם — עם הבוט. תשמעו בעצמכם איך נשמעת שיחה חכמה."
      />
    </>
  );
}
